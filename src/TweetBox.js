...
const TweetBox = () => {
    ...
    const sendTweet=(e)=>{
        ...
        db.collection('posts').add({
            ava:'src="https://pbs.twimg.com/profile_images/1409740849995522049/u85BO_GZ_400x400.jpg"',
